...
parser.add_argument(
    "--logger", type=str, default=None, choices=["tensorboard", "neptune", "wandb"], help="Override the RL logger."
)
parser.add_argument("--run_name", type=str, default="", help="Suffix appended to this run's log directory name.")
parser.add_argument("--learning_rate", type=float, default=None, help="Override the PPO learning rate.")
parser.add_argument("--entropy_coef", type=float, default=None, help="Override the PPO entropy coefficient.")
...
def main():
    ...
    # create runner from rsl-rl (its wandb logger reads agent_cfg.logger / wandb_project)
